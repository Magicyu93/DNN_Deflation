...
# ##############################################################
# everything before is the same as the main.py
# ##############################################################

# read the data
dir_text = "./Results/"
data=pickle.load(open(dir_text+'React_Diff_d_1_B_'+prev_data_ID[0]+'.data', 'rb'))

net_A = network_file.Network(data['d'], data['m'],
                             activation_type = activation,
                             boundary_control_type = boundary_control,
...
net_S = network_file.Network(data['d'], data['m'],
                             activation_type = activation,
                             boundary_control_type = boundary_control,
                             initial_constant = initial_constant,
                             structure_probing_num=6)
